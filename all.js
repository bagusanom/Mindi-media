!function(t, e) {
    ...
    function l(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType)
            if (n = "data-" + e.replace(xt, "-$1").toLowerCase(),
            i = t.getAttribute(n),
            "string" == typeof i) {
                try {
    ...
    function y(e, i) {
        var n, r = J(i.createElement(e)).appendTo(i.body), s = t.getDefaultComputedStyle && (n = t.getDefaultComputedStyle(r[0])) ? n.display : J.css(r[0], "display");
        return r.detach(),
        s
    }
    function x(t) {
        var e = Z
          , i = zt[t];
        return i || (i = y(t, e),
        "none" !== i && i || (Ht = (Ht || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
    ...
    function T(t, e, i) {
        ...
        i && ("" !== o || J.contains(t.ownerDocument, t) || (o = J.style(t, e)),
        $t.test(o) && Wt.test(e) && (n = a.width,
        r = a.minWidth,
        s = a.maxWidth,
    ...
    function S(t, e, i, n, r) {
        for (var s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, o = 0; 4 > s; s += 2)
            ...
            n ? ("content" === i && (o -= J.css(t, "padding" + wt[s], !0, r)),
            "margin" !== i && (o -= J.css(t, "border" + wt[s] + "Width", !0, r))) : (o += J.css(t, "padding" + wt[s], !0, r),
            "padding" !== i && (o += J.css(t, "border" + wt[s] + "Width", !0, r)));
        return o
    }
    function C(t, e, i) {
        var n = !0
    ...
    function k(t, e) {
        for (var i, n, r, s = [], o = 0, a = t.length; a > o; o++)
            n = t[o],
            n.style && (s[o] = _t.get(n, "olddisplay"),
            i = n.style.display,
            e ? (s[o] || "none" !== i || (n.style.display = ""),
            "" === n.style.display && bt(n) && (s[o] = _t.access(n, "olddisplay", x(n.nodeName)))) : (r = bt(n),
            "none" === i && r || _t.set(n, "olddisplay", r ? i : J.css(n, "display"))));
        for (o = 0; a > o; o++)
            n = t[o],
    ...
    function R(t, e, i) {
        var n, r, s, o, a, l, u, h, c = this, f = {}, p = t.style, d = t.nodeType && bt(t), m = _t.get(t, "fxshow");
        i.queue || (a = J._queueHooks(t, "fx"),
        ...
        "inline" === h && "none" === J.css(t, "float") && (p.display = "inline-block")),
    ...
    function E(t, e, i) {
        var n, r, s = 0, o = ee.length, a = J.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var e = Qt || D(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, s = 1 - n, o = 0, l = u.tweens.length; l > o; o++)
                u.tweens[o].run(s);
            return a.notifyWith(t, [u, s, i]),
            1 > s && l ? i : (a.resolveWith(t, [u]),
            !1)
        }, u = a.promise({
            elem: t,
            props: J.extend({}, e),
        ...
        a--); l > a; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = o[e],
                    n = t[e],
                    o !== n && (u && n && (J.isPlainObject(n) || (r = J.isArray(n))) ? (r ? (r = !1,
                    s = i && J.isArray(i) ? i : []) : s = i && J.isPlainObject(i) ? i : {},
                    o[e] = J.extend(u, s, n)) : void 0 !== n && (o[e] = n));
        return o
    }
    ,
    J.extend({
        ...
        globalEval: function(t) {
            ...
            e.text = t,
            Z.head.appendChild(e).parentNode.removeChild(e)) : i(t))
        },
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (i(Object(t)) ? J.merge(n, "string" == typeof t ? [t] : t) : X.call(n, t)),
            n
        },
        ...
        proxy: function(t, e) {
            ...
            e = t,
            t = i),
            J.isFunction(t) ? (n = B.call(arguments, 2),
            r = function() {
    ...
    var rt = function(t) {
        function e(t, e, i, n) {
            ...
            if ((e ? e.ownerDocument || e : z) !== R && M(e),
            e = e || R,
            i = i || [],
            !t || "string" != typeof t)
                return i;
            ...
            if (E && !n) {
                    ...
                    if (o = r[1]) {
                        if (9 === a) {
                            ...
                            if (s.id === o)
                                return i.push(s),
                                i
                        } else if (e.ownerDocument && (s = e.ownerDocument.getElementById(o)) && I(e, s) && s.id === o)
                            return i.push(s),
                            i
                    } else {
                        if (r[2])
                            ...
                            i;
                        if ((o = r[3]) && T.getElementsByClassName && e.getElementsByClassName)
                ...
                if (T.qsa && (!L || !L.test(t))) {
                    ...
                    1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (u = S(t),
                        (c = e.getAttribute("id")) ? p = c.replace(xt, "\\$&") : e.setAttribute("id", p),
                        p = "[id='" + p + "'] ",
                        l = u.length; l--; )
                            u[l] = p + f(u[l]);
                    ...
                    if (m)
                        try {
                            return J.apply(i, d.querySelectorAll(m)),
                            i
                        } catch (g) {} finally {
        ...
        function _(t, e, i, r, s, o) {
            ...
            s && !s[H] && (s = _(s, o)),
            n(function(n, o, a, l) {
                var u, h, c, f = [], p = [], d = o.length, _ = n || m(e || "*", a.nodeType ? [a] : a, []), v = !t || !n && e ? _ : g(_, f, t, a, l), y = i ? s || (n ? t : d || r) ? [] : o : v;
                if (i && i(v, y, a, l),
                r)
                    for (u = g(y, p),
                    r(u, [], a, l),
                ...
                if (n) {
                    if (s || t) {
                        ...
                        for (h = y.length; h--; )
                            (c = y[h]) && (u = s ? et.call(n, c) : f[h]) > -1 && (n[u] = !(o[u] = c))
                    }
                } else
                    y = g(y === o ? y.splice(d, y.length) : y),
                    s ? s(null, o, y, l) : J.apply(o, y)
            })
        }
        function v(t) {
            for (var e, i, n, r = t.length, s = w.relative[t[0].type], o = s || w.relative[" "], a = s ? 1 : 0, l = p(function(t) {
                ...
                if (i = w.relative[t[a].type])
                    ...
                    if (i = w.filter[t[a].type].apply(null, t[a].matches),
                    i[H]) {
        ...
        function y(t, i) {
            var r = i.length > 0
              ...
              , o = function(n, o, a, l, u) {
                var h, c, f, p = 0, d = "0", m = n && [], _ = [], v = O, y = n || s && w.find.TAG("*", u), x = W += null == v ? 1 : Math.random() || .1, T = y.length;
        ...
        var x, T, w, b, P, S, C, k, O, D, A, M, R, N, E, L, j, F, I, H = "sizzle" + -new Date, z = t.document, W = 0, $ = 0, B = i(), q = i(), X = i(), Y = function(t, e) {
            return t === e && (A = !0),
            0
        }, U = "undefined", V = 1 << 31, G = {}.hasOwnProperty, Q = [], Z = Q.pop, K = Q.push, J = Q.push, tt = Q.slice, et = Q.indexOf || function(t) {
            for (var e = 0, i = this.length; i > e; e++)
                if (this[e] === t)
                    return e;
            return -1
        }
        , it = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", rt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", st = rt.replace("w", "w#"), ot = "\\[" + nt + "*(" + rt + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + st + "))|)" + nt + "*\\]", at = ":(" + rt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", lt = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$","g"), ut = new RegExp("^" + nt + "*," + nt + "*"), ht = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ct = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]","g"), ft = new RegExp(at), pt = new RegExp("^" + st + "$"), dt = {
            ID: new RegExp("^#(" + rt + ")"),
            CLASS: new RegExp("^\\.(" + rt + ")"),
        ...
        }, mt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, _t = /^[^{]+\{\s*\[native \w/, vt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, yt = /[+~]/, xt = /'|\\/g, Tt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)","ig"), wt = function(t, e, i) {
            var n = "0x" + e - 65536;
        ...
        M = e.setDocument = function(t) {
            ...
            T.getElementsByClassName = _t.test(i.getElementsByClassName) && r(function(t) {
            ...
            T.getById ? (w.find.ID = function(t, e) {
            ...
            w.find.TAG = T.getElementsByTagName ? function(t, e) {
            ...
            ,
            w.find.CLASS = T.getElementsByClassName && function(t, e) {
                return typeof e.getElementsByClassName !== U && E ? e.getElementsByClassName(t) : void 0
            }
            ,
            j = [],
            L = [],
            (T.qsa = _t.test(i.querySelectorAll)) && (r(function(t) {
                t.innerHTML = "<select msallowclip=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowclip^='']").length && L.push("[*^$]=" + nt + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || L.push("\\[" + nt + "*(?:value|" + it + ")"),
            ...
            (T.matchesSelector = _t.test(F = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function(t) {
            ...
            I = e || _t.test(N.contains) ? function(t, e) {
            ...
            Y = e ? function(t, e) {
                ...
                1 & n || !T.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === z && I(z, t) ? -1 : e === i || e.ownerDocument === z && I(z, e) ? 1 : D ? et.call(D, t) - et.call(D, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return A = !0,
                ...
                if (!s || !a)
                    return t === i ? -1 : e === i ? 1 : s ? -1 : a ? 1 : D ? et.call(D, t) - et.call(D, e) : 0;
                if (s === a)
                    return o(t, e);
        ...
        e.attr = function(t, e) {
            ...
            return void 0 !== n ? n : T.attributes || !E ? t.getAttribute(e) : (n = t.getAttributeNode(e)) && n.specified ? n.value : null
        }
        ,
        e.error = function(t) {
        ...
        w = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return dt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ft.test(i) && (e = S(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(t, i, n) {
                    return function(r) {
                        var s = e.attr(r, t);
                        return null == s ? "!=" === i : !i || (s += "",
                        "=" === i ? s === n : "!=" === i ? s !== n : "^=" === i ? n && 0 === s.indexOf(n) : "*=" === i ? n && s.indexOf(n) > -1 : "$=" === i ? n && s.slice(-n.length) === n : "~=" === i ? (" " + s + " ").indexOf(n) > -1 : "|=" === i && (s === n || s.slice(0, n.length + 1) === n + "-"))
                    }
                },
                CHILD: function(t, e, i, n, r) {
                    ...
                    : function(e, i, l) {
                        var u, h, c, f, p, d, m = s !== o ? "nextSibling" : "previousSibling", g = e.parentNode, _ = a && e.nodeName.toLowerCase(), v = !l && !a;
                        if (g) {
                            if (s) {
                                for (; m; ) {
                                    for (c = e; c = c[m]; )
                            ...
                            o && v) {
                                ...
                                p = u[0] === W && u[1],
                                f = u[0] === W && u[2],
                                c = p && g.childNodes[p]; c = ++p && c && c[m] || (f = p = 0) || d.pop(); )
                                    if (1 === c.nodeType && ++f && c === e) {
                                        h[t] = [W, p, f];
                                        break
                                    }
                            } else if (v && (u = (e[H] || (e[H] = {}))[t]) && u[0] === W)
                                f = u[1];
                            else
                                for (; (c = ++p && c && c[m] || (f = p = 0) || d.pop()) && ((a ? c.nodeName.toLowerCase() !== _ : 1 !== c.nodeType) || !++f || (v && ((c[H] || (c[H] = {}))[t] = [W, f]),
                                c !== e)); )
                                    ;
                            return f -= r,
                            f === n || f % n === 0 && f / n >= 0
                ...
                PSEUDO: function(t, i) {
                    ...
                    return s[H] ? s(i) : s.length > 1 ? (r = [t, t, "", i],
        ...
        S = e.tokenize = function(t, i) {
            ...
            u = w.preFilter; a; ) {
                ...
                a = a.slice(n.length));
                for (o in w.filter)
                    !(r = dt[o].exec(a)) || u[o] && !(r = u[o](r)) || (n = r.shift(),
                    s.push({
                        value: n,
                        type: o,
                        matches: r
        ...
        k = e.select = function(t, e, i, n) {
            ...
            1 === c.length) {
                ...
                s.length > 2 && "ID" === (o = s[0]).type && T.getById && 9 === e.nodeType && E && w.relative[s[1].type]) {
                    if (e = (w.find.ID(o.matches[0].replace(Tt, wt), e) || [])[0],
                    !e)
                        return i;
                    u && (e = e.parentNode),
                    t = t.slice(s.shift().value.length)
                }
                for (r = dt.needsContext.test(t) ? 0 : s.length; r-- && (o = s[r],
                !w.relative[a = o.type]); )
                    if ((l = w.find[a]) && (n = l(o.matches[0].replace(Tt, wt), yt.test(s[0].type) && h(e.parentNode) || e))) {
                        if (s.splice(r, 1),
                        t = n.length && f(s),
                        !t)
                            return J.apply(i, n),
            ...
            return (u || C(t, c))(n, e, !E, i, yt.test(t) && h(e.parentNode) || e),
            i
        }
        ,
    ...
    J.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? J.find.matchesSelector(n, t) ? [n] : [] : J.find.matches(t, J.grep(e, function(t) {
            return 1 === t.nodeType
        }))
    }
    ,
    J.fn.extend({
        find: function(t) {
            ...
            for (e = 0; i > e; e++)
                J.find(t, r[e], n);
            return n = this.pushStack(i > 1 ? J.unique(n) : n),
    ...
    var lt, ut = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ht = J.fn.init = function(t, e) {
        var i, n;
        if (!t)
            return this;
        if ("string" == typeof t) {
            ...
            if (i[1]) {
                ...
                J.merge(this, J.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : Z, !0)),
                ot.test(i[1]) && J.isPlainObject(e))
                    for (i in e)
                        J.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this
            }
            return n = Z.getElementById(i[2]),
    ...
    J.extend({
        ...
        when: function(t) {
            var e, i, n, r = 0, s = B.call(arguments), o = s.length, a = 1 !== o || t && J.isFunction(t.promise) ? o : 0, l = 1 === a ? t : J.Deferred(), u = function(t, i, n) {
                return function(r) {
                    i[t] = this,
            ...
            if (o > 1)
                ...
                i = new Array(o),
                n = new Array(o); o > r; r++)
                    s[r] && J.isFunction(s[r].promise) ? s[r].promise().done(u(r, n, s)).fail(l.reject).progress(u(r, i, e)) : --a;
    ...
    J.extend({
        ...
        ready: function(t) {
            ...
            t !== !0 && --J.readyWait > 0 || (mt.resolveWith(Z, [J]),
    ...
    J.ready.promise = function(e) {
        ...
        "complete" === Z.readyState ? setTimeout(J.ready) : (Z.addEventListener("DOMContentLoaded", o, !1),
    ...
    a.prototype = {
        ...
        set: function(t, e, i) {
            ...
            if ("string" == typeof e)
                s[e] = i;
            else if (J.isEmptyObject(s))
                J.extend(this.cache[r], e);
            else
                for (n in e)
                    s[n] = e[n];
            return s
        ...
        access: function(t, e, i) {
            ...
            void 0 !== n ? n : this.get(t, J.camelCase(e))) : (this.set(t, e, i),
            void 0 !== i ? i : e)
        },
        remove: function(t, e) {
            ...
            if (void 0 === e)
                ...
                J.isArray(e) ? n = e.concat(e.map(J.camelCase)) : (r = J.camelCase(e),
                e in o ? n = [e, r] : (n = r,
                n = n in o ? [n] : n.match(pt) || [])),
                i = n.length;
                for (; i--; )
                    delete o[n[i]]
            }
    ...
    J.fn.extend({
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (r = vt.get(s),
                1 === s.nodeType && !_t.get(s, "hasDataAttrs"))) {
                    for (i = o.length; i--; )
                        o[i] && (n = o[i].name,
                        0 === n.indexOf("data-") && (n = J.camelCase(n.slice(5)),
                        l(s, n, r[n])));
    ...
    J.extend({
        queue: function(t, e, i) {
            ...
            n = _t.get(t, e),
            i && (!n || J.isArray(i) ? n = _t.access(t, e, J.makeArray(i)) : n.push(i)),
            n || []) : void 0
        },
    ...
    J.fn.extend({
        ...
        promise: function(t, e) {
            var i, n = 1, r = J.Deferred(), s = this, o = this.length, a = function() {
                --n || r.resolveWith(s, [s])
            };
    ...
    J.event = {
        ...
        add: function(t, e, i, n, r) {
            var s, o, a, l, u, h, c, f, p, d, m, g = _t.get(t);
            if (g)
                for (i.handler && (s = i,
                i = s.handler,
                r = s.selector),
                ...
                u = e.length; u--; )
                    ...
                    (f = l[p]) || (f = l[p] = [],
                    f.delegateCount = 0,
                    c.setup && c.setup.call(t, n, d, o) !== !1 || t.addEventListener && t.addEventListener(p, o, !1)),
        ...
        remove: function(t, e, i, n, r) {
            var s, o, a, l, u, h, c, f, p, d, m, g = _t.hasData(t) && _t.get(t);
            if (g && (l = g.events)) {
                for (e = (e || "").match(pt) || [""],
                u = e.length; u--; )
                    if (a = Dt.exec(e[u]) || [],
                    ...
                    d = (a[2] || "").split(".").sort(),
                    p) {
                        for (c = J.event.special[p] || {},
                        p = (n ? c.delegateType : c.bindType) || p,
                        f = l[p] || [],
                        a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        o = s = f.length; s--; )
                            h = f[s],
                            !r && m !== h.origType || i && i.guid !== h.guid || a && !a.test(h.namespace) || n && n !== h.selector && ("**" !== n || !h.selector) || (f.splice(s, 1),
                            h.selector && f.delegateCount--,
                            c.remove && c.remove.call(t, h));
                        o && !f.length && (c.teardown && c.teardown.call(t, d, g.handle) !== !1 || J.removeEvent(t, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            J.event.remove(t, p + e[u], i, n, !0);
                J.isEmptyObject(l) && (delete g.handle,
                _t.remove(t, "events"))
            }
        },
        trigger: function(e, i, n, r) {
            var s, o, a, l, u, h, c, f = [n || Z], p = G.call(e, "type") ? e.type : e, d = G.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = a = n = n || Z,
            3 !== n.nodeType && 8 !== n.nodeType && !Ot.test(p + J.event.triggered) && (p.indexOf(".") >= 0 && (d = p.split("."),
            p = d.shift(),
            d.sort()),
            u = p.indexOf(":") < 0 && "on" + p,
            ...
            r || !c.trigger || c.trigger.apply(n, i) !== !1)) {
                if (!r && !c.noBubble && !J.isWindow(n)) {
                    ...
                    Ot.test(l + p) || (o = o.parentNode); o; o = o.parentNode)
                        f.push(o),
                        a = o;
                ...
                for (s = 0; (o = f[s++]) && !e.isPropagationStopped(); )
                    ...
                    h && h.apply(o, i),
                    h = u && o[u],
                    h && h.apply && J.acceptData(o) && (e.result = h.apply(o, i),
                    e.result === !1 && e.preventDefault());
                return e.type = p,
                r || e.isDefaultPrevented() || c._default && c._default.apply(f.pop(), i) !== !1 || !J.acceptData(n) || u && J.isFunction(n[p]) && !J.isWindow(n) && (a = n[u],
                a && (n[u] = null),
                J.event.triggered = p,
                n[p](),
        ...
        dispatch: function(t) {
            t = J.event.fix(t);
            var e, i, n, r, s, o = [], a = B.call(arguments), l = (_t.get(this, "events") || {})[t.type] || [], u = J.event.special[t.type] || {};
            if (a[0] = t,
            t.delegateTarget = this,
            !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                for (o = J.event.handlers.call(this, t, l),
                e = 0; (r = o[e++]) && !t.isPropagationStopped(); )
                    for (t.currentTarget = r.elem,
                    i = 0; (s = r.handlers[i++]) && !t.isImmediatePropagationStopped(); )
                        (!t.namespace_re || t.namespace_re.test(s.namespace)) && (t.handleObj = s,
                        t.data = s.data,
                        n = ((J.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, a),
                ...
                for (; l !== this; l = l.parentNode || this)
                    if (l.disabled !== !0 || "click" !== t.type) {
                        ...
                        i = 0; a > i; i++)
                            s = e[i],
                            r = s.selector + " ",
                            void 0 === n[r] && (n[r] = s.needsContext ? J(r, this).index(l) >= 0 : J.find(r, this, null, [l]).length),
                            n[r] && n.push(s);
                        n.length && o.push({
                            elem: l,
                            handlers: n
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || Z,
                n = i.documentElement,
                r = i.body,
        ...
        fix: function(t) {
            ...
            for (o || (this.fixHooks[r] = o = kt.test(r) ? this.mouseHooks : Ct.test(r) ? this.keyHooks : {}),
        ...
        special: {
            ...
            focus: {
                trigger: function() {
                    return this !== c() && this.focus ? (this.focus(),
                    !1) : void 0
                },
    ...
    J.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? u : h) : this.type = t,
        e && J.extend(this, e),
    ...
    J.each({
        ...
        J.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return (!r || r !== n && !J.contains(n, r)) && (t.type = s.origType,
    ...
    Q.focusinBubbles || J.each({
        ...
        J.event.special[e] = {
            ...
            teardown: function() {
                var n = this.ownerDocument || this
                  , r = _t.access(n, e) - 1;
                r ? _t.access(n, e, r) : (n.removeEventListener(t, i, !0),
                _t.remove(n, e))
            }
        }
    }),
    J.fn.extend({
        ...
        off: function(t, e, i) {
            ...
            if (t && t.preventDefault && t.handleObj)
                ...
                J(t.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler),
                this;
            if ("object" == typeof t) {
                for (r in t)
                    this.off(r, e, t[r]);
    ...
    J.extend({
        clone: function(t, e, i) {
            var n, r, s, o, a = t.cloneNode(!0), l = J.contains(t.ownerDocument, t);
            ...
            if (e)
                if (i)
                    ...
                    g(t, a);
            return o = _(a, "script"),
            o.length > 0 && m(o, !l && _(t, "script")),
            a
        },
        buildFragment: function(t, e, i, n) {
            for (var r, s, o, a, l, u, h = e.createDocumentFragment(), c = [], f = 0, p = t.length; p > f; f++)
                if (r = t[f],
                r || 0 === r)
                    if ("object" === J.type(r))
                        J.merge(c, r.nodeType ? [r] : r);
                    else if (Rt.test(r)) {
                        ...
                        c.push(e.createTextNode(r));
            for (h.textContent = "",
            f = 0; r = c[f++]; )
                if ((!n || -1 === J.inArray(r, n)) && (l = J.contains(r.ownerDocument, r),
                s = _(h.appendChild(r), "script"),
                l && m(s),
                i))
                    for (u = 0; r = s[u++]; )
                        Lt.test(r.type || "") && i.push(r);
            return h
        },
        cleanData: function(t) {
            for (var e, i, n, r, s = J.event.special, o = 0; void 0 !== (i = t[o]); o++) {
                if (J.acceptData(i) && (r = i[_t.expando],
                r && (e = _t.cache[r]))) {
                    if (e.events)
                        for (n in e.events)
    ...
    J.fn.extend({
        ...
        remove: function(t, e) {
            for (var i, n = t ? J.filter(t, this) : this, r = 0; null != (i = n[r]); r++)
                e || 1 !== i.nodeType || J.cleanData(_(i)),
                i.parentNode && (e && J.contains(i.ownerDocument, i) && m(_(i, "script")),
                i.parentNode.removeChild(i));
            return this
        },
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (J.cleanData(_(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return gt(this, function(t) {
                ...
                if (void 0 === t && 1 === e.nodeType)
                    return e.innerHTML;
                if ("string" == typeof t && !Nt.test(t) && !It[(Mt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = t.replace(At, "<$1></$2>");
                    try {
                        for (; n > i; i++)
                            e = this[i] || {},
                            1 === e.nodeType && (J.cleanData(_(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (r) {}
                }
        ...
        domManip: function(t, e) {
            t = q.apply([], t);
            var i, n, r, s, o, a, l = 0, u = this.length, h = this, c = u - 1, f = t[0], m = J.isFunction(f);
            if (m || u > 1 && "string" == typeof f && !Q.checkClone && Et.test(f))
                return this.each(function(i) {
                    var n = h.eq(i);
                    m && (t[0] = f.call(this, i, n.html())),
                    n.domManip(t, e)
                });
            if (u && (i = J.buildFragment(t, this[0].ownerDocument, !1, this),
            n = i.firstChild,
            1 === i.childNodes.length && (i = n),
            n)) {
                for (r = J.map(_(i, "script"), p),
                s = r.length; u > l; l++)
                    o = i,
                    l !== c && (o = J.clone(o, !0, !0),
                    s && J.merge(r, _(o, "script"))),
                    e.call(this[l], o, l);
                if (s)
                    ...
                    l = 0; s > l; l++)
                        o = r[l],
                        Lt.test(o.type || "") && !_t.access(o, "globalEval") && J.contains(a, o) && (o.src ? J._evalUrl && J._evalUrl(o.src) : J.globalEval(o.textContent.replace(Ft, "")))
            }
            return this
        }
    }),
    ...
    var Ht, zt = {}, Wt = /^margin/, $t = new RegExp("^(" + Tt + ")(?!px)[a-z%]+$","i"), Bt = function(t) {
    ...
    J.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, s, o, a = J.camelCase(e), l = t.style;
                return e = J.cssProps[a] || (J.cssProps[a] = b(l, a)),
                o = J.cssHooks[e] || J.cssHooks[a],
                void 0 === i ? o && "get"in o && void 0 !== (r = o.get(t, !1, n)) ? r : l[e] : (s = typeof i,
                "string" === s && (r = Yt.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(J.css(t, e)),
                s = "number"),
                void (null != i && i === i && ("number" !== s || J.cssNumber[a] || (i += "px"),
        ...
        css: function(t, e, i, n) {
            ...
            return e = J.cssProps[a] || (J.cssProps[a] = b(t.style, a)),
            o = J.cssHooks[e] || J.cssHooks[a],
            o && "get"in o && (r = o.get(t, !0, i)),
            void 0 === r && (r = T(t, e, n)),
            "normal" === r && e in Vt && (r = Vt[e]),
            "" === i || i ? (s = parseFloat(r),
            i === !0 || J.isNumeric(s) ? s || 0 : r) : r
        }
    }),
    J.each(["height", "width"], function(t, e) {
        J.cssHooks[e] = {
            get: function(t, i, n) {
                return i ? qt.test(J.css(t, "display")) && 0 === t.offsetWidth ? J.swap(t, Ut, function() {
                    return C(t, e, n)
                }) : C(t, e, n) : void 0
            },
            set: function(t, i, n) {
    ...
    J.fx.step = {};
    var Qt, Zt, Kt = /^(?:toggle|show|hide)$/, Jt = new RegExp("^(?:([+-])=|)(" + Tt + ")([a-z%]*)$","i"), te = /queueHooks$/, ee = [R], ie = {
        "*": [function(t, e) {
    ...
    J.fn.extend({
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
            this.each(function() {
                var e, i = _t.get(this), n = i[t + "queue"], r = i[t + "queueHooks"], s = J.timers, o = n ? n.length : 0;
                for (i.finish = !0,
                J.queue(this, t, []),
    ...
    J.extend({
        attr: function(t, e, i) {
            ...
            if (t && 3 !== s && 8 !== s && 2 !== s)
                return typeof t.getAttribute === St ? J.prop(t, e, i) : (1 === s && J.isXMLDoc(t) || (e = e.toLowerCase(),
                n = J.attrHooks[e] || (J.expr.match.bool.test(e) ? re : ne)),
                void 0 === i ? n && "get"in n && null !== (r = n.get(t, e)) ? r : (r = J.find.attr(t, e),
                null == r ? void 0 : r) : null !== i ? n && "set"in n && void 0 !== (r = n.set(t, i, e)) ? r : (t.setAttribute(e, i + ""),
                i) : void J.removeAttr(t, e))
        },
        removeAttr: function(t, e) {
            var i, n, r = 0, s = e && e.match(pt);
            if (s && 1 === t.nodeType)
                for (; i = s[r++]; )
                    n = J.propFix[i] || i,
    ...
    J.fn.extend({
        addClass: function(t) {
            var e, i, n, r, s, o, a = "string" == typeof t && t, l = 0, u = this.length;
            if (J.isFunction(t))
        ...
        removeClass: function(t) {
            var e, i, n, r, s, o, a = 0 === arguments.length || "string" == typeof t && t, l = 0, u = this.length;
            if (J.isFunction(t))
                return this.each(function(e) {
        ...
        toggleClass: function(t, e) {
            ...
            : function() {
                if ("string" === i)
                    for (var e, n = 0, r = J(this), s = t.match(pt) || []; e = s[n++]; )
                        r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
                else
                    (i === St || "boolean" === i) && (this.className && _t.set(this, "__className__", this.className),
                    this.className = this.className || t === !1 ? "" : _t.get(this, "__className__") || "")
            }
            )
        },
        hasClass: function(t) {
    ...
    J.fn.extend({
        val: function(t) {
            var e, i, n, r = this[0];
            return arguments.length ? (n = J.isFunction(t),
            this.each(function(i) {
                var r;
                1 === this.nodeType && (r = n ? t.call(this, i, J(this).val()) : t,
                null == r ? r = "" : "number" == typeof r ? r += "" : J.isArray(r) && (r = J.map(r, function(t) {
                    return null == t ? "" : t + ""
                })),
                e = J.valHooks[this.type] || J.valHooks[this.nodeName.toLowerCase()],
                e && "set"in e && void 0 !== e.set(this, r, "value") || (this.value = r))
            })) : r ? (e = J.valHooks[r.type] || J.valHooks[r.nodeName.toLowerCase()],
            ...
            select: {
                get: function(t) {
                    for (var e, i, n = t.options, r = t.selectedIndex, s = "select-one" === t.type || 0 > r, o = s ? null : [], a = s ? r + 1 : n.length, l = 0 > r ? a : s ? r : 0; a > l; l++)
                        if (i = n[l],
                        !(!i.selected && l !== r || (Q.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && J.nodeName(i.parentNode, "optgroup"))) {
                            if (e = J(i).val(),
                            s)
                                return e;
                            o.push(e)
                ...
                set: function(t, e) {
                    for (var i, n, r = t.options, s = J.makeArray(e), o = r.length; o--; )
                        n = r[o],
    ...
    ;
    var ce, fe, pe = /#.*$/, de = /([?&])_=[^&]*/, me = /^(.*?):[ \t]*([^\r\n]*)$/gm, ge = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, _e = /^(?:GET|HEAD)$/, ve = /^\/\//, ye = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, xe = {}, Te = {}, we = "*/".concat("*");
    try {
        fe = location.href
    } catch (be) {
    ...
    J.extend({
        ...
        ajax: function(t, e) {
            function i(t, e, i, o) {
                ...
                i && (v = I(c, T, i)),
                v = H(c, v, T, l),
                l ? (c.ifModified && (x = T.getResponseHeader("Last-Modified"),
                x && (J.lastModified[r] = x),
                x = T.getResponseHeader("etag"),
                x && (J.etag[r] = x)),
                204 === t || "HEAD" === c.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = v.state,
                h = v.data,
                _ = v.error,
                l = !_)) : (_ = w,
                (t || !w) && (w = "error",
            ...
            t = void 0),
            e = e || {};
            var n, r, s, o, a, l, u, h, c = J.ajaxSetup({}, e), f = c.context || c, p = c.context && (f.nodeType || f.jquery) ? J(f) : J.event, d = J.Deferred(), m = J.Callbacks("once memory"), g = c.statusCode || {}, _ = {}, v = {}, y = 0, x = "canceled", T = {
                readyState: 0,
            ...
            if (d.promise(T).complete = m.add,
            T.success = T.done,
            T.error = T.fail,
            c.url = ((t || c.url || fe) + "").replace(pe, "").replace(ve, ce[1] + "//"),
            c.type = e.method || e.type || c.method || c.type,
            c.dataTypes = J.trim(c.dataType || "*").toLowerCase().match(pt) || [""],
            null == c.crossDomain && (l = ye.exec(c.url.toLowerCase()),
            c.crossDomain = !(!l || l[1] === ce[1] && l[2] === ce[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (ce[3] || ("http:" === ce[1] ? "80" : "443")))),
            ...
            r = c.url,
            c.hasContent || (c.data && (r = c.url += (he.test(r) ? "&" : "?") + c.data,
            delete c.data),
            c.cache === !1 && (c.url = de.test(r) ? r.replace(de, "$1_=" + ue++) : r + (he.test(r) ? "&" : "?") + "_=" + ue++)),
            c.ifModified && (J.lastModified[r] && T.setRequestHeader("If-Modified-Since", J.lastModified[r]),
            J.etag[r] && T.setRequestHeader("If-None-Match", J.etag[r])),
            (c.data && c.hasContent && c.contentType !== !1 || e.contentType) && T.setRequestHeader("Content-Type", c.contentType),
            T.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + we + "; q=0.01" : "") : c.accepts["*"]);
            for (h in c.headers)
                T.setRequestHeader(h, c.headers[h]);
    ...
    J.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !J(this).is(":disabled") && Oe.test(this.nodeName) && !ke.test(t) && (this.checked || !Pt.test(t))
            }).map(function(t, e) {
                var i = J(this).val();
            ...
            send: function(i, n) {
                ...
                e = function(t) {
                    return function() {
                        ...
                        "abort" === t ? s.abort() : "error" === t ? n(s.status, s.statusText) : n(Me[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                            text: s.responseText
    ...
    J.ajaxPrefilter("json jsonp", function(e, i, n) {
        ...
        a ? e[a] = e[a].replace(Ee, "$1" + r) : e.jsonp !== !1 && (e.url += (he.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
        e.converters["script json"] = function() {
            return o || J.error(r + " was not called"),
            o[0]
        }
        ,
        e.dataTypes[0] = "json",
    ...
    J.parseHTML = function(t, e, i) {
        ...
        var n = ot.exec(t)
          , r = !i && [];
        return n ? [e.createElement(n[1])] : (n = J.buildFragment([t], e, r),
    ...
    J.offset = {
        setOffset: function(t, e, i) {
            var n, r, s, o, a, l, u, h = J.css(t, "position"), c = J(t), f = {};
            "static" === h && (t.style.position = "relative"),
            a = c.offset(),
            s = J.css(t, "top"),
            l = J.css(t, "left"),
            u = ("absolute" === h || "fixed" === h) && (s + l).indexOf("auto") > -1,
            u ? (n = c.position(),
            o = n.top,
    ...
    J.fn.extend({
        offset: function(t) {
            ...
            J.contains(e, n) ? (typeof n.getBoundingClientRect !== St && (r = n.getBoundingClientRect()),
            i = W(s),
            {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || je; t && !J.nodeName(t, "html") && "static" === J.css(t, "position"); )
                    t = t.offsetParent;
                return t || je
            })
        }
    ...
    J.each(["top", "left"], function(t, e) {
        J.cssHooks[e] = w(Q.pixelPosition, function(t, i) {
            return i ? (i = T(t, e),
            $t.test(i) ? J(t).position()[e] + "px" : i) : void 0
        })
    }),
    J.each({
        Height: "height",
        ...
        J.each({
            ...
            J.fn[n] = function(n, r) {
                ...
                return gt(this, function(e, i, n) {
                    ...
                    Math.max(e.body["scroll" + t], r["scroll" + t], e.body["offset" + t], r["offset" + t], r["client" + t])) : void 0 === n ? J.css(e, i, o) : J.style(e, i, n, o)
                }, e, s ? n : void 0, s, null)
            }
        })
    }),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        u.render = function(t, e, i) {
            ...
            var n, r, a, l, u, c, f, p, d = this._dirty ? this.totalDuration() : this._totalDuration, m = this._time, g = this._totalTime, _ = this._cycle, v = this._duration, y = this._rawPrevTime;
            ...
            this.ratio = 1 === c ? 1 - u : 2 === c ? u : .5 > this._time / v ? u / 2 : 1 - u / 2) : this.ratio = this._ease.getRatio(this._time / v)),
            m === this._time && !i && _ === this._cycle)
                return void (g !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || h)));
            if (!this._initted) {
                if (this._init(),
            ...
            e || (this._totalTime !== g || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || h)),
            this._cycle !== _ && (e || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || h)),
        ...
        r.staggerTo = r.allTo = function(t, e, s, o, u, c, f) {
            o = o || 0;
            var p, d, m, g, _ = s.delay || 0, v = [], y = function() {
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        var n = function(t) {
          ...
          , d = o.pauseCallback = function(t, e, i, n) {
            var s, o = t._timeline, a = o._totalTime, l = t._startTime, u = 0 > t._rawPrevTime || 0 === t._rawPrevTime && o._reversed, h = u ? 0 : r, f = u ? r : 0;
            if (e || !this._forcingPlayhead) {
                for (o.pause(l),
                s = t._prev; s && s._startTime === l; )
                    s._rawPrevTime = f,
                    s = s._prev;
        ...
        g.render = function(t, e, i) {
            ...
            var n, s, o, a, l, f = this._dirty ? this.totalDuration() : this._totalDuration, p = this._time, d = this._startTime, m = this._timeScale, g = this._paused;
            if (t >= f)
            ...
            if (this._time !== p && this._first || i || l) {
                ...
                a && (this._gc || (d === this._startTime || m !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (s && (u.length && h(),
    ...
    _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(t, e, i) {
        ...
        h.render = function(t, e, i) {
            this._gc && this._enabled(!0, !1);
            var n, o, u, h, c, f, p = this._dirty ? this.totalDuration() : this._totalDuration, d = this._duration, m = this._time, g = this._totalTime, _ = this._startTime, v = this._timeScale, y = this._rawPrevTime, x = this._paused, T = this._cycle;
            if (t >= p)
                ...
                this._time = 0,
                (0 !== m || 0 === d && y !== r && (y > 0 || 0 > t && y >= 0) && !this._locked) && (h = "onReverseComplete",
                o = this._reversed),
                0 > t)
                    this._active = !1,
                ...
                0 !== this._repeat && (f = d + this._repeatDelay,
            ...
            0 === g && this.vars.onStart && 0 !== this._totalTime && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || s)),
            this._time >= m)
                for (n = this._first; n && (u = n._next,
                !this._paused || x); )
                    (n._active || n._startTime <= this._time && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                    n = u;
            else
                for (n = this._last; n && (u = n._prev,
                !this._paused || x); )
            ...
            h && (this._locked || this._gc || (_ === this._startTime || v !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (o && (a.length && l(),
            this._timeline.autoRemoveChildren && this._enabled(!1, !1),
            this._active = !1),
            !e && this.vars[h] && this.vars[h].apply(this.vars[h + "Scope"] || this, this.vars[h + "Params"] || s)))
        }
        ,
    ...
    function() {
        var t = 180 / Math.PI
          ...
          , u = function(t, r, s, o, a) {
            var u, h, c, f, p, d, m, g, _, v, y, x, T, w = t.length - 1, b = 0, P = t[0].a;
            for (u = 0; w > u; u++)
                p = t[b],
                h = p.a,
                c = p.d,
                ...
                a ? (y = e[u],
                x = i[u],
                T = .25 * (x + y) * r / (o ? .5 : n[u] || .5),
                d = c - (c - h) * (o ? .5 * r : 0 !== y ? T / y : 0),
                m = c + (f - c) * (o ? .5 * r : 0 !== x ? T / x : 0),
                g = c - (d + ((m - d) * (3 * y / (y + x) + .5) / 4 || 0))) : (d = c - .5 * (c - h) * r,
                m = c + .5 * (f - c) * r,
                g = c - (d + m) / 2),
                d += g,
                m += g,
          ...
          , c = function(t, s, o, l, c, f) {
            var p, d, m, g, _, v, y, x, T = {}, w = [], b = f || t[0];
          ...
          , f = function(t, e, i) {
            e = e || "soft";
            var n, r, s, a, l, u, h, c, f, p, d, m = {}, g = "cubic" === e ? 3 : 2, _ = "soft" === e, v = [];
            if (_ && i && (t = [i].concat(t)),
            null == t || g + 1 > t.length)
            ...
            for (u = v.length; --u > -1; ) {
                ...
                c = t.length,
                h = 0; c > h; h++)
                    n = null == i ? t[h][f] : "string" == typeof (d = t[h][f]) && "=" === d.charAt(1) ? i[f] + Number(d.charAt(0) + d.substr(2)) : Number(d),
          ...
          , d = function(t, e) {
            e = e >> 0 || 6;
            var i, n, r, s, o = [], a = [], l = 0, u = 0, h = e - 1, c = [], f = [];
            for (i in t)
                p(t[i], o, e);
            for (r = o.length,
            n = 0; r > n; n++)
          ...
          , m = _gsScope._gsDefine.plugin({
            ...
            init: function(t, e, i) {
                ...
                var n, r, s, o, a, l = e.values || [], u = {}, h = l[0], p = e.autoRotate || i.vars.orientToBezier;
                ...
                for (s = this._props.length; --s > -1; )
                    ...
                    a || u[n] !== l[0][n] && (a = u);
                if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a) : f(l, e.type, u),
            ...
            set: function(e) {
                ...
                r = this._props.length; --r > -1; )
                    ...
                    p[s] ? d[s](l) : d[s] = l;
                if (this._autoRotate) {
                    var g, _, v, y, x, T, w, b = this._autoRotate;
                    for (r = b.length; --r > -1; )
                        s = b[r][2],
                        T = b[r][3] || 0,
                        w = b[r][4] === !0 ? 1 : t,
                        ...
                        v += (x - v) * a,
                        x += (g.c + (g.d - g.c) * a - x) * a,
                        l = m ? Math.atan2(x - v, y - _) * w + T : this._initialRotations[r],
                        p[s] ? d[s](l) : d[s] = l)
                }
            }
        })
            ...
            if (t) {
                ...
                e._registerComplexSpecialProp("bezier", {
                    parser: function(t, e, s, o, a, l) {
                        ...
                        l = new m;
                        var u, h, c, f = e.values, p = f.length - 1, d = [], g = {};
                        if (0 > p)
                            return a;
                        for (u = 0; p >= u; u++)
                            c = i(t, f[u], o, a, l, p !== u),
                        ...
                        g.autoRotate = null != c.end.left ? [["left", "top", "rotation", u, !1]] : null != c.end.x && [["x", "y", "rotation", u, !1]]),
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var h, c, f, p, d, m, g = /(?:\d|\-\d|\.\d|\-\.\d)+/g, _ = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, v = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, y = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, x = /(?:\d|\-|\+|=|#|\.)*/g, T = /opacity *= *([^)]*)/i, w = /opacity:([^;]*)/i, b = /alpha\(opacity *=.+?\)/i, P = /^(rgb|hsl)/, S = /([A-Z])/g, C = /-([a-z])/gi, k = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, O = function(t, e) {
            return e.toUpperCase()
        }, D = /(?:Left|Right|Width)/i, A = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, M = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, R = /,(?=[^\)]*(?:\(|$))/gi, N = Math.PI / 180, E = 180 / Math.PI, L = {}, j = document, F = function(t) {
            return j.createElementNS ? j.createElementNS("http://www.w3.org/1999/xhtml", t) : j.createElement(t)
        }, I = F("div"), H = F("img"), z = o._internals = {
            _specialProps: l
        }, W = navigator.userAgent, $ = function() {
            var t = W.indexOf("Android")
              , e = F("a");
            return f = -1 !== W.indexOf("Safari") && -1 === W.indexOf("Chrome") && (-1 === t || Number(W.substr(t + 8, 1)) > 3),
        ...
        , G = o.getStyle = function(t, e, i, n, r) {
            var s;
            return $ || "opacity" !== e ? (!n && t.style[e] ? s = t.style[e] : (i = i || V(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(S, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]),
            null == r || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : r) : B(t)
        }
        , Q = z.convertToPixels = function(t, i, n, r, s) {
            ...
            if ("auto" === r || !n)
                return 0;
            var a, l, u, h = D.test(i), c = t, f = I.style, p = 0 > n;
            if (p && (n = -n),
            "%" === r && -1 !== i.indexOf("border"))
                a = n / 100 * (h ? t.clientWidth : t.clientHeight);
            else {
                if (f.cssText = "border:0 solid red;position:" + G(t, "position") + ";line-height:0;",
                "%" !== r && c.appendChild)
        ...
        , K = function(t, e) {
            ...
            if (e = e || V(t, null))
                if (i = e.length)
                    for (; --i > -1; )
                        r = e[i],
                        (-1 === r.indexOf("-transform") || bt === r) && (s[r.replace(C, O)] = e.getPropertyValue(r));
                else
                    for (i in e)
            ...
            s = t.split("_"),
            l = "=" === t.charAt(1),
            o = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : E) - (l ? 0 : e),
            s.length && (n && (n[i] = e + o),
        ...
        var ct = function(t, e, i, n) {
            if (null == t)
                ...
                ;
            var r, s = e ? (t.match(ht) || [""])[0] : "", o = t.split(s).join("").match(v) || [], a = t.substr(0, t.indexOf(o[0])), l = ")" === t.charAt(t.length - 1) ? ")" : "", u = -1 !== t.indexOf(" ") ? " " : ",", h = o.length, c = h > 0 ? o[0].replace(g, "") : "";
        ...
        function(t, e, i, n, r) {
          ...
          , dt = (z._parseToProxy = function(t, e, i, n, r, s) {
        ...
        z.CSSPropTween = function(t, e, n, r, o, a, l, u, h, c, f) {
          ...
          , mt = o.parseComplex = function(t, e, i, n, r, s, o, a, l, u) {
            ...
            n += "";
            var c, f, p, d, m, v, y, x, T, w, b, S, C = i.split(", ").join(",").split(" "), k = n.split(", ").join(",").split(" "), O = C.length, D = h !== !1;
            for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (C = C.join(" ").replace(R, ", ").split(" "),
            k = k.join(" ").replace(R, ", ").split(" "),
            O = C.length),
            O !== k.length && (C = (s || "").split(" "),
            O = C.length),
            o.plugin = l,
            o.setRatio = u,
            c = 0; O > c; c++)
                ...
                x = parseFloat(d),
                x || 0 === x)
                    o.appendXtra("", x, rt(m, x), m.replace(_, ""), D && -1 !== m.indexOf("px"), !0);
                else if (r && ("#" === d.charAt(0) || at[d] || P.test(d)))
                    S = "," === m.charAt(m.length - 1) ? ")," : ")",
                    d = ut(d),
                    m = ut(m),
                    T = d.length + m.length > 6,
                    T && !$ && 0 === m[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent",
                    o.e = o.e.split(k[c]).join("transparent")) : ($ || (T = !1),
                    o.appendXtra(T ? "rgba(" : "rgb(", d[0], m[0] - d[0], ",", !0, !0).appendXtra("", d[1], m[1] - d[1], ",", !0).appendXtra("", d[2], m[2] - d[2], T ? "," : S, !0),
                    T && (d = 4 > d.length ? 1 : d[3],
                    ...
                    f = 0; v.length > f; f++)
                        b = v[f],
                        w = d.indexOf(b, p),
                        o.appendXtra(d.substr(p, w - p), Number(b), rt(y[f], b), "", D && "px" === d.substr(w + b.length, 2), 0 === f),
                        p = w + b.length;
                    o["xs" + o.l] += d.substr(p)
                } else
                    o["xs" + o.l] += o.l ? " " + d : d;
        ...
        var xt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), wt = U("transform"), bt = X + "transform", Pt = U("transformOrigin"), St = null !== U("perspective"), Ct = z.Transform = function() {
            this.perspective = parseFloat(o.defaultTransformPerspective) || 0,
            this.force3D = !(o.defaultForce3D === !1 || !St) && (o.defaultForce3D || "auto")
        }
        , kt = window.SVGElement, Ot = function(t, e, i) {
            ...
            r
        }, Dt = j.documentElement, At = function() {
            var t, e, i, n = m || /Android/i.test(W) && !window.chrome;
            return j.createElementNS && !n && (t = Ot("svg", Dt),
            e = Ot("rect", t, {
                width: 100,
                height: 50,
                x: 100
            ...
            var r, s;
            n && (s = n.split(" ")).length || (r = t.getBBox(),
            e = nt(e).split(" "),
            s = [(-1 !== e[0].indexOf("%") ? parseFloat(e[0]) / 100 * r.width : parseFloat(e[0])) + r.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * r.height : parseFloat(e[1])) + r.y]),
            ...
            var s, a, l, u, h, c, f, p, d, m, g = i ? t._gsTransform || new Ct : new Ct, _ = 0 > g.scaleX, v = 2e-5, y = 1e5, x = St ? parseFloat(G(t, Pt, e, !1, "0 0 0").split(" ")[2]) || g.zOrigin || 0 : 0, T = parseFloat(o.defaultTransformPerspective) || 0;
            if (wt ? a = G(t, bt, e, !0) : t.currentStyle && (a = t.currentStyle.filter.match(A),
            a = a && 4 === a.length ? [a[0].substr(4), Number(a[2].substr(4)), Number(a[1].substr(4)), a[3].substr(4), g.x || 0, g.y || 0].join(",") : ""),
            ...
            g.svg && (s && -1 !== (t.style[wt] + "").indexOf("matrix") && (a = t.style[wt],
            s = !1),
            Mt(t, G(t, Pt, r, !1, "50% 50%") + "", g, t.getAttribute("data-svg-origin")),
            ...
            !s) {
                ...
                u = l.length; --u > -1; )
                    h = Number(l[u]),
                    l[u] = (c = h - (h |= 0)) ? (0 | c * y + (0 > c ? -.5 : .5)) / y + h : h;
                if (16 === l.length) {
                    var w, b, P, S, C, k = l[0], O = l[1], D = l[2], M = l[3], R = l[4], N = l[5], L = l[6], j = l[7], F = l[8], I = l[9], H = l[10], z = l[12], W = l[13], $ = l[14], B = l[11], q = Math.atan2(L, H);
                    g.zOrigin && ($ = -g.zOrigin,
                    z = F * $ - l[12],
                    W = I * $ - l[13],
                    $ = H * $ + g.zOrigin - l[14]),
                    ...
                    g.rotationY += 180),
                    g.scaleX = (0 | Math.sqrt(k * k + O * O) * y + .5) / y,
                    g.scaleY = (0 | Math.sqrt(N * N + I * I) * y + .5) / y,
                    g.scaleZ = (0 | Math.sqrt(L * L + H * H) * y + .5) / y,
                    g.skewX = 0,
                    g.perspective = B ? 1 / (0 > B ? -B : B) : 0,
                    g.x = z,
                    g.y = W,
                    g.z = $,
                    g.svg && (g.x -= g.xOrigin - (g.xOrigin * k - g.yOrigin * R),
                    ...
                    Math.abs(m) > 90 && 270 > Math.abs(m) && (_ ? (f *= -1,
                    m += 0 >= d ? 180 : -180,
                    d += 0 >= d ? 180 : -180) : (p *= -1,
                    m += 0 >= m ? 180 : -180)),
                    g.scaleX = f,
                    ...
                    g.rotation = d,
                    g.skewX = m,
                    St && (g.rotationX = g.rotationY = g.z = 0,
                    g.perspective = T,
                    g.scaleZ = 1),
                    g.svg && (g.x -= g.xOrigin - (g.xOrigin * Y - g.yOrigin * U),
            ...
            return i && (t._gsTransform = g,
            g.svg && (xt && t.style[wt] ? jt(t.style, wt) : !xt && t.getAttribute("transform") && t.removeAttribute("transform"))),
            g
        }
        , Nt = function(t) {
            var e, i, n = this.data, r = -n.rotation * N, s = r + n.skewX * N, o = 1e5, a = (0 | Math.cos(r) * n.scaleX * o) / o, l = (0 | Math.sin(r) * n.scaleX * o) / o, u = (0 | Math.sin(s) * -n.scaleY * o) / o, h = (0 | Math.cos(s) * n.scaleY * o) / o, c = this.t.style, f = this.t.currentStyle;
            if (f) {
                i = l,
                l = -u,
                u = -i,
                e = f.filter,
                c.filter = "";
                var p, d, g = this.t.offsetWidth, _ = this.t.offsetHeight, v = "absolute" !== f.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + u + ", M22=" + h, w = n.x + g * n.xPercent / 100, b = n.y + _ * n.yPercent / 100;
                ...
                v ? (p = g / 2,
                d = _ / 2,
                y += ", Dx=" + (p - (p * a + d * l) + w) + ", Dy=" + (d - (p * u + d * h) + b) + ")") : y += ", sizingMethod='auto expand')",
                c.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(M, y) : y + " " + e,
                ...
                !v) {
                    ...
                    n.ieOffsetY = Math.round((_ - ((0 > h ? -h : h) * _ + (0 > u ? -u : u) * g)) / 2 + b),
                    gt = 0; 4 > gt; gt++)
                        S = et[gt],
                        P = f[S],
                        i = -1 !== P.indexOf("px") ? parseFloat(P) : Q(this.t, S, parseFloat(P), P.replace(x, "")) || 0,
                        C = i !== n[S] ? 2 > gt ? -n.ieOffsetX : -n.ieOffsetY : 2 > gt ? p - n.ieOffsetX : d - n.ieOffsetY,
                        c[S] = (n[S] = Math.round(i - C * (0 === gt || 2 === gt ? 1 : k))) + "px"
                }
            }
        }, Et = z.set3DTransformRatio = z.setTransformRatio = function(t) {
            var e, i, n, r, s, o, a, l, u, h, c, f, d, m, g, _, v, y, x, T, w, b, P, S = this.data, C = this.t.style, k = S.rotation, O = S.rotationX, D = S.rotationY, A = S.scaleX, M = S.scaleY, R = S.scaleZ, E = S.x, L = S.y, j = S.z, F = S.svg, I = S.perspective, H = S.force3D;
            if (!((1 !== t && 0 !== t || "auto" !== H || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && H || j || I || D || O) || xt && F || !St)
                return void (k || S.skewX || F ? (k *= N,
                b = S.skewX * N,
                P = 1e5,
                e = Math.cos(k) * A,
                r = Math.sin(k) * A,
                ...
                S.skewY && (e *= v,
                r *= v)),
                F && (E += S.xOrigin - (S.xOrigin * e + S.yOrigin * i),
                L += S.yOrigin - (S.xOrigin * r + S.yOrigin * s),
                m = 1e-6,
                m > E && E > -m && (E = 0),
                m > L && L > -m && (L = 0)),
                x = (0 | e * P) / P + "," + (0 | r * P) / P + "," + (0 | i * P) / P + "," + (0 | s * P) / P + "," + E + "," + L + ")",
                F && xt ? this.t.setAttribute("transform", "matrix(" + x) : C[wt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + x) : C[wt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + A + ",0,0," + M + "," + E + "," + L + ")");
            if (p && (m = 1e-4,
            m > A && A > -m && (A = R = 2e-5),
            m > M && M > -m && (M = R = 2e-5),
            ...
            k || S.skewX)
                ...
                if (!(D || O || 1 !== R || I || F))
                    return void (C[wt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + E + "px," + L + "px," + j + "px)" + (1 !== A || 1 !== M ? " scale(" + A + "," + M + ")" : ""));
                e = s = 1,
                i = r = 0
            }
            u = 1,
            ...
            x += (m > e && e > -m ? w : e) + T + (m > r && r > -m ? w : r) + T + (m > a && a > -m ? w : a),
            x += T + (m > h && h > -m ? w : h) + T + (m > i && i > -m ? w : i) + T + (m > s && s > -m ? w : s),
            O || D ? (x += T + (m > l && l > -m ? w : l) + T + (m > c && c > -m ? w : c) + T + (m > n && n > -m ? w : n),
            x += T + (m > o && o > -m ? w : o) + T + (m > u && u > -m ? w : u) + T + (m > f && f > -m ? w : f) + T) : x += ",0,0,0,0,1,0,",
        ...
        vt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser: function(t, e, i, n, s, a, l) {
                ...
                var u, h, c, f, p, d, m, g = n._transform = Rt(t, r, !0, l.parseTransform), _ = t.style, v = 1e-6, y = Tt.length, x = l, T = {};
                if ("string" == typeof x.transform && wt)
                    ...
                    null != m)
                        if ("object" == typeof m)
                            ...
                            x.rotation = m;
                    "string" == typeof x.x && -1 !== x.x.indexOf("%") && (u.x = 0,
                    u.xPercent = st(x.x, g.xPercent)),
                    "string" == typeof x.y && -1 !== x.y.indexOf("%") && (u.y = 0,
                    u.yPercent = st(x.y, g.yPercent)),
                    u.rotation = ot("rotation"in x ? x.rotation : "shortRotation"in x ? x.shortRotation + "_short" : "rotationZ"in x ? x.rotationZ : g.rotation, g.rotation, "rotation", T),
                    St && (u.rotationX = ot("rotationX"in x ? x.rotationX : "shortRotationX"in x ? x.shortRotationX + "_short" : g.rotationX || 0, g.rotationX, "rotationX", T),
                    u.rotationY = ot("rotationY"in x ? x.rotationY : "shortRotationY"in x ? x.shortRotationY + "_short" : g.rotationY || 0, g.rotationY, "rotationY", T)),
                    u.skewX = null == x.skewX ? g.skewX : ot(x.skewX, g.skewX),
                    u.skewY = null == x.skewY ? g.skewY : ot(x.skewY, g.skewY),
                    (h = u.skewY - g.skewY) && (u.skewX += h,
                    u.rotation += h)
                }
                for (St && null != x.force3D && (g.force3D = x.force3D,
                d = !0),
                ...
                p || null == x.scale || (u.scaleZ = 1); --y > -1; )
                    i = Tt[y],
                    f = u[i] - g[i],
                    (f > v || -v > f || null != x[i] || null != L[i]) && (d = !0,
                    s = new dt(g,i,g[i],f,s),
                    i in T && (s.e = T[i]),
                    s.xs0 = 0,
                    s.plugin = a,
                    n._overwriteProps.push(s.n));
                return f = x.transformOrigin,
                g.svg && (f || x.svgOrigin) && (Mt(t, nt(f), u, x.svgOrigin),
                s = new dt(g,"xOrigin",g.xOrigin,u.xOrigin - g.xOrigin,s,(-1),"transformOrigin"),
                s.b = g.xOrigin,
                s.e = s.xs0 = u.xOrigin,
                s = new dt(g,"yOrigin",g.yOrigin,u.yOrigin - g.yOrigin,s,(-1),"transformOrigin"),
                s.b = g.yOrigin,
                s.e = s.xs0 = u.yOrigin,
                f = xt ? null : "0px 0px"),
                (f || St && p && g.zOrigin) && (wt ? (d = !0,
                i = Pt,
                f = (f || G(t, i, r, !1, "50% 50%")) + "",
                ...
                St ? (c = g.zOrigin,
                f = f.split(" "),
                g.zOrigin = (f.length > 2 && (0 === c || "0px" !== f[2]) ? parseFloat(f[2]) : c) || 0,
                s.xs0 = s.e = f[0] + " " + (f[1] || "50%") + " 0px",
                s = new dt(g,"zOrigin",0,0,s,(-1),s.n),
                s.b = c,
                s.xs0 = s.e = g.zOrigin) : s.xs0 = s.e = f) : nt(f + "", g)),
                d && (n._transformType = g.svg && xt || !p && 3 !== this._transformType ? 2 : 3),
                s
            },
            prefix: !0
        }),
        ...
        vt("borderRadius", {
            ...
            parser: function(t, e, i, s, o) {
                e = this.format(e);
                var a, l, u, h, c, f, p, d, m, g, _, v, y, x, T, w, b = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], P = t.style;
                ...
                l = 0; b.length > l; l++)
                    ...
                    v = c.substr((p + "").length),
                    y = "=" === f.charAt(1),
                    y ? (d = parseInt(f.charAt(0) + "1", 10),
                    f = f.substr(2),
                    d *= parseFloat(f),
                    _ = f.substr((d + "").length - (0 > d ? 1 : 0)) || "") : (d = parseFloat(f),
                    _ = f.substr((d + "").length)),
                    "" === _ && (_ = n[i] || v),
                    _ !== v && (x = Q(t, "borderLeft", p, v),
                    T = Q(t, "borderTop", p, v),
                    "%" === _ ? (c = 100 * (x / m) + "%",
                    h = 100 * (T / g) + "%") : "em" === _ ? (w = Q(t, "borderLeft", 1, "em"),
                    c = x / w + "em",
                    h = T / w + "em") : (c = x + "px",
                    h = T + "px"),
                    y && (f = parseFloat(c) + d + _,
                    u = parseFloat(h) + d + _)),
        ...
        vt("backgroundPosition", {
            ...
            parser: function(t, e, i, n, s, o) {
                var a, l, u, h, c, f, p = "background-position", d = r || V(t, null), g = this.format((d ? m ? d.getPropertyValue(p + "-x") + " " + d.getPropertyValue(p + "-y") : d.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), _ = this.format(e);
                if (-1 !== g.indexOf("%") != (-1 !== _.indexOf("%")) && (f = G(t, "backgroundImage").replace(k, ""),
                f && "none" !== f)) {
                    for (a = g.split(" "),
                    l = _.split(" "),
                    ...
                    u = 2; --u > -1; )
                        g = a[u],
                        h = -1 !== g.indexOf("%"),
                        h !== (-1 !== l[u].indexOf("%")) && (c = 0 === u ? t.offsetWidth - H.width : t.offsetHeight - H.height,
                        a[u] = h ? parseFloat(g) / 100 * c + "px" : 100 * (parseFloat(g) / c) + "%");
                    g = a.join(" ")
                }
        ...
        vt("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, n, s, o) {
                ...
                $ ? s = new dt(l,"opacity",a,e - a,s) : (s = new dt(l,"opacity",100 * a,100 * (e - a),s),
                s.xn1 = u ? 1 : 0,
                l.zoom = 1,
                s.type = 2,
                ...
                s.plugin = o,
                s.setRatio = Lt),
                u && (s = new dt(l,"visibility",0,0,s,(-1),null,(!1),0,0 !== a ? "inherit" : "hidden",0 === e ? "hidden" : "inherit"),
                s.xs0 = "inherit",
                n._overwriteProps.push(s.n),
        ...
        u._onInitTween = function(t, e, a) {
            ...
            var u, p, m, g, _, v, y, x, T, b = t.style;
            if (c && "" === b.zIndex && (u = G(t, "zIndex", r),
            ("auto" === u || "" === u) && this._addLazySet(b, "zIndex", 0)),
            "string" == typeof e && (g = b.cssText,
            u = K(t, r),
            b.cssText = g + ";" + e,
            u = J(t, u, K(t)).difs,
            ...
            this._transformType) {
                ...
                wt ? f && (c = !0,
                "" === b.zIndex && (y = G(t, "zIndex", r),
                ("auto" === y || "" === y) && this._addLazySet(b, "zIndex", 0)),
                d && this._addLazySet(b, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden"))) : b.zoom = 1,
                m = p; m && m._next; )
                    m = m._next;
        ...
        u.parse = function(t, e, i, s) {
            ...
            for (o in e)
                p = e[o],
                a = l[o],
                a ? i = a.parse(t, p, o, this, i, s, e) : (f = G(t, o, r) + "",
                g = "string" == typeof p,
                "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || g && P.test(p) ? (g || (p = ut(p),
                p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                i = mt(v, o, f, p, !0, "transparent", i, 0, s)) : !g || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (u = parseFloat(f),
                d = u || 0 === u ? f.substr((u + "").length) : "",
                ("" === f || "auto" === f) && ("width" === o || "height" === o ? (u = it(t, o, r),
                d = "px") : "left" === o || "top" === o ? (u = Z(t, o, r),
                d = "px") : (u = "opacity" !== o ? 0 : 1,
                d = "")),
                _ = g && "=" === p.charAt(1),
                _ ? (c = parseInt(p.charAt(0) + "1", 10),
                p = p.substr(2),
                c *= parseFloat(p),
                ...
                d !== m && "" !== m && (c || 0 === c) && u && (u = Q(t, o, u, d),
                "%" === m ? (u /= Q(t, o, 100, "%") / 100,
                e.strictUnits !== !0 && (f = u + "%")) : "em" === m ? u /= Q(t, o, 1, "em") : "px" !== m && (c = Q(t, o, c, m),
                m = "px"),
                _ && (c || 0 === c) && (p = c + u + m)),
                _ && (c += u),
                !u && 0 !== u || !c && 0 !== c ? void 0 !== v[o] && (p || "NaN" != p + "" && null != p) ? (i = new dt(v,o,c || u || 0,0,i,(-1),o,(!1),0,f,p),
                i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : f) : q("invalid " + o + " tween value: " + e[o]) : (i = new dt(v,o,u,c - u,i,0,o,h !== !1 && ("px" === m || "zIndex" === o),0,f,p),
                i.xs0 = m)) : i = mt(v, o, f, p, !0, null, i, 0, s)),
    ...
    _gsScope._gsDefine.plugin({
        ...
        init: function(t, e) {
            ...
            for (i in e)
                ...
                (o > u || -u > o) && (this._addTween(t, i, r, r + o, i),
                this._overwriteProps.push(i)));
            return !0
        },
        set: function(t) {
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(t) {
        ...
        i = l("easing.RoughEase", function(e) {
            e = e || {};
            for (var i, n, r, s, o, a, l = e.taper || "none", u = [], h = 0, c = 0 | (e.points || 20), p = c, d = e.randomize !== !1, m = e.clamp === !0, g = e.template instanceof t ? e.template : null, _ = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1; )
...
function(t, e) {
    ...
    if (!i.TweenLite) {
        var n, r, s, o, a, l = function(t) {
            ...
            this.check = function(u) {
                for (var h, c, f, p, g = r.length, _ = g; --g > -1; )
                    (h = d[r[g]] || new m(r[g],[])).gsClass ? (a[g] = h.gsClass,
                    _--) : u && h.sc.push(this);
                if (0 === _ && s)
        ...
        r = n.length; --r > -1; )
            ...
            w(new x(null,null,2,r), s, "easeIn" + (0 === r ? ",easeNone" : "")),
        ...
        s.addEventListener = function(t, e, i, n, r) {
            ...
            l = u.length; --l > -1; )
                s = u[l],
                s.c === e && s.s === i ? u.splice(l, 1) : 0 === h && r > s.pr && (h = l + 1);
            u.splice(h, 0, {
                c: e,
                s: i,
                up: n,
        ...
        _("Ticker", function(t, e) {
            var i, n, r, s, l, u = this, c = C(), p = e !== !1 && P, d = 500, m = 33, g = "tick", _ = function(t) {
                var e, o, a = C() - k;
                a > d && (c += a - m),
                k += a,
                u.time = (k - c) / 1e3,
        ...
        s.paused = function(t) {
            ...
            return t != this._paused && n && (a || t || o.wake(),
            e = n.rawTime(),
            i = e - this._pauseTime,
        ...
        var M = _("TweenLite", function(e, i, n) {
            ...
            if (this._overwrite = l = null == l ? W[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : W[l],
            (a || e instanceof Array || e.push && p(e)) && "number" != typeof e[0])
                ...
                r = 0; o.length > r; r++)
                    ...
                    this._targets = o = o.concat(c(s))) : (this._siblings[r] = Y(s, this, !1),
                    1 === l && this._siblings[r].length > 1 && V(s, this, null, 1, this._siblings[r])) : (s = o[r--] = M.selector(s),
          ...
          , N = function(t, e) {
            var i, n = {};
            for (i in t)
                z[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!F[i] || F[i] && F[i]._autoCSS) || (n[i] = t[i],
                delete t[i]);
            t.css = n
        };
        s = M.prototype = new O,
        ...
        O._updateRoot = M.render = function() {
            ...
            o.frame >= q) {
                ...
                if (i = B._first,
                (!i || i._paused) && M.autoSleep && !$._first && 1 === o._listeners.tick.length) {
                    for (; i && i._paused; )
                        i = i._next;
                    i || o.sleep()
                }
        ...
        var Y = function(t, e, i) {
          ...
          , V = function(t, e, i, n, r) {
            ...
            for (s = r.length; --s > -1; )
                (a = r[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (u = u || G(e, 0, d),
                0 === G(a, u, d) && (f[p++] = a)) : c >= a._startTime && a._startTime + a.totalDuration() / a._timeScale > c && ((d || !a._initted) && 2e-10 >= c - a._startTime || (f[p++] = a)));
            for (s = p; --s > -1; )
                if (a = f[s],
        ...
        s._init = function() {
            ...
            if (this._ease = u = u ? u instanceof x ? u : "function" == typeof u ? new x(u,s.easeParams) : T[u] || M.defaultEase : M.defaultEase,
        ...
        s._initProps = function(e, i, n, r) {
            ...
            if (null == e)
                return !1;
            L[e._gsTweenID] && X(),
            this.vars.css || e.style && e !== t && e.nodeType && F.css && this.vars.autoCSS !== !1 && N(this.vars, e);
            for (s in this.vars) {
                if (h = this.vars[s],
                z[s])
                    ...
                    u.s = u.f ? e[s.indexOf("set") || "function" != typeof e["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : parseFloat(e[s]),
            ...
            this._initProps(e, i, n, r)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (L[e._gsTweenID] = !0),
            a)
        }
        ,
        s.render = function(t, e, i) {
            ...
            if (t >= l)
                ...
                (0 === t || 0 > u || u === h && "isPause" !== this.data) && u !== t && (i = !0,
            ...
            this._easeType) {
                ...
                this.ratio = 1 === f ? 1 - c : 2 === f ? c : .5 > t / l ? c / 2 : 1 - c / 2
            } else
...
!function(t) {
    ...
    var e = t.GreenSockGlobals || t
      ...
      , l = function(t, e, i, n) {
        var r;
        return (i = i || o(t, null)) ? (t = i.getPropertyValue(e.replace(a, "-$1").toLowerCase()),
      ...
      , g = n.SplitText = e.SplitText = function(t, e) {
        if ("string" == typeof t && (t = g.selector(t)),
        !t)
      ...
      , y = function(t, e, i, n, a) {
        ...
        var u, h, p, d, g, y, x, T, w, b, P, S, C, k, O = r(t), D = e.type || e.split || "chars,words,lines", A = -1 !== D.indexOf("lines") ? [] : null, M = -1 !== D.indexOf("words"), R = -1 !== D.indexOf("chars"), N = "absolute" === e.position || e.absolute === !0, E = N ? "&#173; " : " ", L = -999, j = o(t), F = l(t, "paddingLeft", j), I = l(t, "borderBottomWidth", j) + l(t, "borderTopWidth", j), H = l(t, "borderLeftWidth", j) + l(t, "borderRightWidth", j), z = l(t, "paddingTop", j) + l(t, "paddingBottom", j), W = l(t, "paddingLeft", j) + l(t, "paddingRight", j), $ = l(t, "textAlign", j, !0), B = t.clientHeight, q = t.clientWidth, X = "</div>", Y = m(e.wordsClass), U = m(e.charsClass), V = -1 !== (e.linesClass || "").indexOf("++"), G = e.linesClass, Q = -1 !== O.indexOf("<"), Z = !0, K = [], J = [], tt = [];
        ...
        g = 0; u > g; g++)
            ...
            ")" === x && O.substr(g, 20) === c)
                ...
                Z = !1; " " === O.charAt(g + 1); )
                    d += E,
                    g++;
                (")" !== O.charAt(g + 1) || O.substr(g + 1, 20) !== c) && (d += E + Y(),
                Z = !0)
            } else
                d += R && " " !== x ? U() + x + "</div>" : x;
        for (t.innerHTML = d + (Z ? X : ""),
        Q && _(t, "{{LT}}", "<"),
        ...
        if (A || N)
            for (g = 0; u > g; g++)
                w = T[g],
                p = w.parentNode === t,
                (p || N || R && !M) && (b = w.offsetTop,
                A && p && b !== L && "BR" !== w.nodeName && (h = [],
                A.push(h),
                L = b),
                N && (w._x = w.offsetLeft,
                w._y = b,
                ...
                "BR" === w.nodeName && w.nextSibling && "BR" === w.nextSibling.nodeName && A.push([])));
        for (g = 0; u > g; g++)
            w = T[g],
            p = w.parentNode === t,
            "BR" !== w.nodeName ? (N && (S = w.style,
            M || p || (w._x += w.parentNode._x,
            ...
            S.width = w._w + 1 + "px",
            S.height = w._h + "px"),
            M ? p && "" !== w.innerHTML ? J.push(w) : R && K.push(w) : p ? (t.removeChild(w),
            T.splice(g--, 1),
            u--) : !p && R && (b = !A && !N && w.nextSibling,
            t.appendChild(w),
            b || t.appendChild(s.createTextNode(" ")),
            K.push(w))) : A || N ? (t.removeChild(w),
            T.splice(g--, 1),
            u--) : M || t.appendChild(w);
        if (A) {
            for (N && (P = s.createElement("div"),
            t.appendChild(P),
            C = P.offsetWidth + "px",
            ...
            g = 0; A.length > g; g++) {
                ...
                P.style.cssText = "display:block;text-align:" + $ + ";position:" + (N ? "absolute;" : "relative;"),
                G && (P.className = G + (V ? g + 1 : "")),
                tt.push(P),
                u = h.length,
                y = 0; u > y; y++)
                    "BR" !== h[y].nodeName && (w = h[y],
                    P.appendChild(w),
                    k && (w._wordEnd || M) && P.appendChild(s.createTextNode(" ")),
                    N && (0 === y && (P.style.top = w._y + "px",
                    P.style.left = F + b + "px"),
                    w.style.top = "0px",
                    b && (w.style.left = w._x - b + "px")));
                0 === u && (P.innerHTML = "&nbsp;"),
                M || R || (P.innerHTML = r(P).split(String.fromCharCode(160)).join(" ")),
                N && (P.style.width = C,
        ...
        N && (B > t.clientHeight && (t.style.height = B - z + "px",
        B > t.clientHeight && (t.style.height = B + I + "px")),
        q > t.clientWidth && (t.style.width = q - W + "px",
...
!function t(e, i, n) {
    ...
    1: [function(t, e, i) {
        ...
        function l(t, e) {
            ...
            t && !i || (t ? (document.addEventListener("wheel", s, {
                passive: !1
            }),
            document.addEventListener("keydown", a),
            p.on("click", o),
            i.classList.add("is-open")) : (document.removeEventListener("wheel", s),
        ...
        m.menuAnim.add(TweenMax.fromTo(m.navLeft, .3, {
            alpha: 0,
            y: 20
        }, {
            alpha: 1,
        ...
        m.menuAnim.add(TweenMax.staggerFromTo(m.navCenter, .5, {
            alpha: 0,
            y: 20
        }, {
            alpha: 1,
        ...
        $(document).on("click touchend", "#btn--menu", function(t) {
            t.preventDefault(),
            m.wW <= 850 && (m.menuOpen ? m.menuAnim.reverse(0) : m.menuAnim.play(0))
        }),
        ...
        $(document).on("click touchend", "[data-goto]", function(t) {
            ...
            !m.transitioning) {
                var e = $(this).attr("href")
                  , i = $(this).data("goto");
                if ("home" === m.currentPage && ("/" === e && TweenMax.to(window, 1, {
                    scrollTo: {
                ...
                e.indexOf("#about") !== -1 && TweenMax.to(window, 1, {
                    scrollTo: {
        ...
        $(window).scroll(function() {
            if ("home" != m.currentPage) {
                var t = Math.round(Math.min(.08 * m.scrollTop, 100));
        ...
        $(document).mousemove(function() {
            ...
            if (!m.transitioning) {
                var i = e * (1 - m.posY / (m.wH / 2));
                i = Math.round(Math.min(Math.max(i, t), e)),
                m.wW > 920 && m.secLeftGr.length > 0 && TweenMax.to(m.secLeftGr, 1, {
                    rotationZ: -i,
                    scale: 1.5,
                    force3D: !0,
                    ease: Quad.easeOut
        ...
        m.resizeVideo = function() {
            var t = m.wH / 1080
              , e = m.wW / 1920;
            e > t ? m.video.height("auto").width(m.wW + "px") : m.video.height(m.wH + "px").width("auto")
        }
        ,
        m.track = function(t) {
        ...
        $(document).ready(function() {
            ...
            history.pushState(m.currentPage, "", document.location.pathname)
        }),
        $(window).load(function() {
            $("html").removeClass("preload"),
            m.onPageLoad(m.currentPage)
        }),
        ...
        window.onpopstate = function(t) {
            if (null !== t.state && !m.transitioning) {
                ...
                m.currentPage !== i && m.pageTransition.startTransition(e, i, !0)
            }
        }
    }
    , {
    ...
    2: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            var i = this;
            i.mobile = !!/iPhone|iPad|iPod|Android|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
    ...
    3: [function(t, e, i) {
        ...
        e.exports = function(t, e) {
            ...
            i.init = function() {
                ...
                i.setImagesSize(),
                0 !== i.index && TweenMax.set(i.DOMel.img, {
                    y: 0,
                    scale: i.maxScale,
                    force3D: !0
                }),
            ...
            i.onScroll = function(t) {
                ...
                for (var n = i.distToTop / i.height, r = (0 !== i.index && W.homeSections[i.index - 1],
                i.index !== W.homeSections.length - 1 && W.homeSections[i.index + 1]), s = 0; s < W.homeSections.length; s++)
                    t + i.height / 2 >= W.homeSections[s].offsetTop && (e = W.homeSections[s].index);
                if (i.index == e && i.DOMel.navBar.removeClass("current").eq(e).addClass("current"),
                i.scrollTop > i.offsetTop + i.height) {
                    if (0 === i.index && i.DOMel.scrollInfo.addClass("hide"),
                    n <= 1) {
                        var o = (1 - n).toFixed(2);
            ...
            i.onMousemove = function(t) {
                ...
                W.wW > 920 && TweenMax.to(i.DOMel.gr, 1, {
                    rotationZ: t,
                    scale: 1.5,
                    force3D: !0,
                    ease: Quad.easeOut
    ...
    4: [function(t, e, i) {
        ...
        e.exports = function() {
            ...
            t.seashell.src = "../themes/nagaeight/assets/img/illustrations/standing-stones__dark_2x.jpg",
            t.seashellDim = {},
            t.init = function() {
                t.setCanvasSize(),
                t.centerSeashell(),
            ...
            t.centerSeashell = function() {
                ...
                t.seashellDim.posX = .5 * t.canvasW - t.seashellDim.width / 2,
                t.seashellDim.posY = -(.1585 * t.seashellDim.height),
            ...
            t.startTransition = function(e, i, n) {
                ...
                $('#header nav a[data-goto="' + i + '"]').eq(0).addClass("current"),
                t.DOM.separatorL.length > 0 ? (t.hideText(),
                TweenMax.to(t.DOM.separatorL, .8, {
                    x: 0,
                    scaleX: 9,
            ...
            t.hideText = function() {
                if (t.DOM.h2.length) {
                    ...
                    TweenMax.staggerTo(t.splitH3.words, .6, {
                        delay: .1,
                        y: "-300%",
                        ease: Power3.easeIn,
                        force3D: !0
            ...
            t.showText = function() {
                if (t.DOM.h2.length) {
                    ...
                    TweenMax.staggerFrom(t.splitH3.words, .6, {
                        delay: .3,
                        y: "-300%",
                        ease: Power3.easeOut,
                        force3D: !0
            ...
            t.closeMask = function() {
                return $("html").removeClass("transitioning loading-page"),
                "booking" === t.dest ? (TweenMax.set([t.rectPoints1.BL, t.rectPoints1.BR], {
                    y: 0
                }),
            ...
            ,
            t.draw = function() {
                t.running && (t.ctx.clearRect(0, 0, t.canvasW, t.canvasH),
                t.ctx.beginPath(),
                ...
                t.ctx.fill(),
                t.clipImage(t.seashell, t.seashellDim.posX, t.seashellDim.posY, t.seashellDim.width, t.seashellDim.height),
            ...
            t.loadPage = function(e, i) {
                ...
                $("#page-container").load(e + " #page-container>*", function() {
                    ...
                    W.secLeftGr = $(".section--left .background--gradient"),
                    setTimeout(function() {
                        t.showText(),
                        t.closeMask(),
                        e.indexOf("#") !== -1 && TweenMax.to(window, 1, {
                            delay: .5,
                            scrollTo: {
            ...
            ,
            t.onResize = function() {
                t.running || (t.DOM.canvas = document.getElementById("c"),
                t.setCanvasSize(),
                t.centerSeashell(),
                t.getRectPoints())
            }
